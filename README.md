...
Increasing the training window decreased the return volatilty and decreased the overall return.
Decreasing the training window increased the volatilty of the return with about the same overall return as shown in the pngs.
